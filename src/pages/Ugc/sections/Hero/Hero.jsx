  ...
  return (
    <HeroContainer>
      ...
      <ImageContent {...fadeProps} transition={{ duration: 0.8, delay: 0.4 }}>
        <img
          src="/Videosugc/Ugc.png"
          alt="Retrato de creadora de contenido UGC de Estudio Paz Aranguren"
          loading="eager"
          fetchPriority="high"
          decoding="async"
        />
        <SocialLinks>
          <a href="https://www.tiktok.com/@gicupazok" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.instagram.com/gicupaz" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512" fill="currentColor">
